...
\title{Laboratorio de Biomecánica\\Pr\'{a}ctica 3\\Refuerza el cable de un telef\'{e}rico} % titulo
\date{\today}
...
\begin{figure}[h] % figura
    \centering
    \includegraphics[width=80mm]{images/MatLab2.png} % archivo
    \caption{Codigo de Matlab P1}
\end{figure}

\begin{figure}[h] % figura
    \centering
    \includegraphics[width=85mm]{images/MatLab3.png} % archivo
...
\begin{figure}[h] % figura
    \centering
    \includegraphics[width=85mm]{images/MatLab4.png} % archivo
    \caption{Codigo de Matlab P3}
\end{figure}

\begin{figure}[h] % figura
    \centering
    \includegraphics[width=80mm]{images/MatLab5.png} % archivo
    \caption{Codigo de Matlab P4}
\end{figure}

\begin{figure}[h] % figura
    \centering
    \includegraphics[width=80mm]{images/MatLab6.png} % archivo
...
\begin{figure}[h] % figura
    \centering
    \includegraphics[width=40mm]{images/MatLab7.png} % archivo
